...
// *  @generated
// */
//package com.xinghuan.thrift_server;
//
...
//@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2022-09-02")
...
//
//    public void getById(int id, AsyncMethodCallback resultHandler) throws TException;
//
//    public void isExist(String name, AsyncMethodCallback resultHandler) throws TException;
//
//  }
//
...
//    }
//
//    public void send_getById(int id) throws TException
//    {
...
//    }
//
//    public void send_isExist(String name) throws TException
//    {
...
//    }
//
//    public boolean recv_isExist() throws TException
//    {
...
//      private int id;
//      public getById_call(int id, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
...
//      private String name;
//      public isExist_call(String name, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
//        super(client, protocolFactory, transport, resultHandler, false);
//        this.name = name;
//      }
//
...
//      }
//
//      public isExist_result getResult(I iface, isExist_args args) throws TException {
//        isExist_result result = new isExist_result();
...
//      }
//
//      public void start(I iface, isExist_args args, AsyncMethodCallback<Boolean> resultHandler) throws TException {
...
//
//      public void read(org.apache.thrift.protocol.TProtocol iprot, isExist_args struct) throws TException {
//        org.apache.thrift.protocol.TField schemeField;
//        iprot.readStructBegin();
//        while (true)
//        {
...
//      }
//
//      public void write(org.apache.thrift.protocol.TProtocol oprot, isExist_args struct) throws TException {
//        struct.validate();
//
//        oprot.writeStructBegin(STRUCT_DESC);
//        if (struct.name != null) {
...
//
//      @Override
//      public void write(org.apache.thrift.protocol.TProtocol prot, isExist_args struct) throws TException {
//        TTupleProtocol oprot = (TTupleProtocol) prot;
//        BitSet optionals = new BitSet();
//        if (struct.isSetName()) {
//          optionals.set(0);
...
//
//      @Override
//      public void read(org.apache.thrift.protocol.TProtocol prot, isExist_args struct) throws TException {
//        TTupleProtocol iprot = (TTupleProtocol) prot;
//        BitSet incoming = iprot.readBitSet(1);
//        if (incoming.get(0)) {
//          struct.name = iprot.readString();
...
//
//      public void read(org.apache.thrift.protocol.TProtocol iprot, isExist_result struct) throws TException {
//        org.apache.thrift.protocol.TField schemeField;
//        iprot.readStructBegin();
//        while (true)
//        {
...
//      }
//
//      public void write(org.apache.thrift.protocol.TProtocol oprot, isExist_result struct) throws TException {
//        struct.validate();
//
//        oprot.writeStructBegin(STRUCT_DESC);
//        if (struct.isSetSuccess()) {
...
//
//      @Override
//      public void write(org.apache.thrift.protocol.TProtocol prot, isExist_result struct) throws TException {
//        TTupleProtocol oprot = (TTupleProtocol) prot;
//        BitSet optionals = new BitSet();
//        if (struct.isSetSuccess()) {
//          optionals.set(0);
...
//
//      @Override
//      public void read(org.apache.thrift.protocol.TProtocol prot, isExist_result struct) throws TException {
//        TTupleProtocol iprot = (TTupleProtocol) prot;
//        BitSet incoming = iprot.readBitSet(1);
//        if (incoming.get(0)) {
//          struct.success = iprot.readBool();
